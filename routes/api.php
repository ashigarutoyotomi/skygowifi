...
use App\Http\Controllers\Affiliate\AffiliateLink\AffiliateLinksController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::group(['prefix' => '/affiliate-links'], function () {
        Route::post('/generate', [AffiliateLinksController::class, 'generate']);
        Route::get('/', [AffiliateLinksController::class, 'index']);
    });
});
